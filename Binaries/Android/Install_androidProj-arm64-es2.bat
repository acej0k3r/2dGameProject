...
%ADB% %DEVICE% install androidProj-arm64-es2.apk
...
%ADB% %DEVICE% push main.1.com.PhoenixCore.androidProj.obb %STORAGE%/obb/com.PhoenixCore.androidProj/main.1.com.PhoenixCore.androidProj.obb
if "%ERRORLEVEL%" NEQ "0" goto Error
